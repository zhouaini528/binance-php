...
//    protected $version='v3';
     ...
     * */
    public function postOrder(array $data, string $version = Version::V3)
    {
        $this->type = 'POST';
     ...
     * */
    public function postOrderTest(array $data, string $version = Version::V3)
    {
        $this->type = 'POST';
        $this->path = '/api/' . $version . '/order/test';
        $data['timestamp'] = time() . '000';
        $this->data = $data;
        return $this->exec();
    }
     ...
     * timestamp    LONG    YES
     * */
    public function deleteOrder(array $data, string $version = Version::V3)
    {
        $this->type = 'DELETE';
        $this->path = '/api/' . $version . '/order';
     ...
     * timestamp    LONG    YES
     * */
    public function deleteAllOrders(array $data, string $version = Version::V3)
    {
        $this->type = 'DELETE';
     ...
     * */
    public function postOrderOco(array $data = [], string $version = Version::V3)
    {
        $this->type = 'POST';
        $this->path = '/api/' . $version . '/order/oco';
     ...
     * */
    public function deleteOrderList(array $data = [], string $version = Version::V3)
    {
        $this->type = 'DELETE';
